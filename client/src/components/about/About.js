    ...
    return (
      <div className="about">
        <div className="container">
          <div className="row">
            <div className="col-md-6 text-center about-header">
              <h1 className="display-4 mb-4 about-title">About</h1>
              <div className="about-paragraphs">
                ...
                <p className="about-text">
                  ...
                  whether it be on a personal or large-scale project. Feel free
                  to email me using the contact form below.
                </p>
              </div>
            </div>
            <div className="col-md-6 text-center skills-header">
              <h1 className="display-4 mb-4 skills-title">Skills</h1>
            </div>
          </div>
        </div>
      </div>
